...
namespace Posts.Function
{
    public static class posts
    {
        ...
        public static async Task<IActionResult> getPost(
            [HttpTrigger(AuthorizationLevel.Function, "get", Route = "post/{id}")] HttpRequest req,
            ILogger log,
            string id)
        {
            log.LogInformation("C# HTTP trigger function processed a request.");
        ...
        public static async Task<IActionResult> postPost(
        ...
        public static async Task<IActionResult> deletePost(
            [HttpTrigger(AuthorizationLevel.Function, "delete", Route = "post/{id}")] HttpRequest req,
            ILogger log,
            string id)
        {
            log.LogInformation("C# HTTP trigger function processed a request.");
        ...
        public static async Task<IActionResult> modifyPost(
            [HttpTrigger(AuthorizationLevel.Function, "put", Route = "post/{id}")] HttpRequest req,
            ILogger log,
            string id)
        {
            log.LogInformation("C# HTTP trigger function processed a request.");
